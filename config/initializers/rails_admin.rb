# RailsAdmin config file. Generated on June 28, 2012 11:03
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Webmil Eu', 'Admin']
  ...
  # config.excluded_models = [Picture, Work]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models = [Picture, Work]
